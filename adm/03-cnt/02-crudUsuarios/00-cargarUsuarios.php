<?php
	...
	$respuesta.='	
		<tr>									
			...
			<td><input type="text" name"usuarioCEDU" id="usuarioCEDU" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
			<td><input type="text" name"nombres" id="nombres" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
			<td><input type="text" name"apellidos" id="apellidos" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
			<td><input type="text" name"correo" id="correo" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
			<td><input type="text" name"usuario" id="usuario" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
			<td><input type="password" name"contrasena" id="contrasena" style="width:150px" onkeyup="cambiarFondoInput(this.id)"></td>
	...
	while($fila1=mysqli_fetch_array($sql01)){//$fila1 es un arr. multidemensional que contiene arr. con cada registro de cada tabla.
		...
		$respuesta.='
                ...
                <td style="text-align:left;!important" id="nombres'.$fila1["usuarioID"].'"><img style="width:10px;height:10px;!important" title="Click para modificar" src="../appsArt/editarOn.png" onclick="actualizarInputUsuario(this.parentNode.id,'.$fila1["usuarioID"].',\'nombres\',\'nombresAct'.$fila1["usuarioID"].'\')">'.$fila1["nombres"].'</td>	
                ...
                <td style="text-align:left;!important" id="tdCorreo'.$fila1["usuarioID"].'"><img style="width:10px;height:10px;!important" title="Click para modificar" src="../appsArt/editarOn.png" onclick="actualizarInputUsuario(this.parentNode.id,'.$fila1["usuarioID"].',\'correo\',\'correoAct'.$fila1["usuarioID"].'\')">'.$fila1["correo"].'</td>
                <td style="text-align:left;!important" id="tdUsuario'.$fila1["usuarioID"].'"><img style="width:10px;height:10px;!important" title="Click para modificar" src="../appsArt/editarOn.png" onclick="actualizarInputUsuario(this.parentNode.id,'.$fila1["usuarioID"].',\'usuario\',\'usuarioAct'.$fila1["usuarioID"].'\')">'.$fila1["usuario"].'</td>
                <td style="text-align:left;!important" id="tdConstrasena'.$fila1["usuarioID"].'"><img style="width:10px;height:10px;!important" title="Click para modificar" src="../appsArt/editarOn.png" onclick="actualizarInputUsuario(this.parentNode.id,'.$fila1["usuarioID"].',\'contrasena\',\'contrasenaAct'.$fila1["usuarioID"].'\')">'.$fila1["contrasena"].'</td>
