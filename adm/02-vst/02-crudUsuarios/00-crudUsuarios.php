				...
				<div id="baseDeDatos">
					<div class="baseDeDatos">
						...
						<table class="tablaBD">
							<thead>
								<tr>
									<th class="encabezadoTablaUsuarios" style="width:80px">ID</th>
									...
									<th class="encabezadoTablaUsuarios" style="width:200px">NOMBRES</th>
   								...
   								<tr>
   									<td class="encabezadoTablaUsuarios" style="text-align:center"><img src="../appsArt/ordenarAZOn.png" title="Ordenar A-Z" onclick="ordenarUsuario(\'usuarioID\',0)"/><img class="imgOrden" src="../appsArt/ordenarZAOn.png" onclick="ordenarUsuario(\'usuarioID\',1)"/></td>
									...
									<td class="encabezadoTablaUsuarios" style="text-align:center"><img src="../appsArt/ordenarAZOn.png" title="Ordenar A-Z" onclick="ordenarUsuario(\'nombres\',0)"/><img class="imgOrden" src="../appsArt/ordenarZAOn.png" onclick="ordenarUsuario(\'nombres\',1)"/></td>
